...
router.post('/reset-password', (0, catchAsync_1.catchAsync)(authController_1.resetPassword));
router.patch('/update-password', authMiddleware_1.protect, (0, catchAsync_1.catchAsync)(authController_1.updatePassword));
